...
public interface LoaderCallbackInterface
{
    ...
    /**
     * OpenCV opencv3 installation has been canceled by the user.
     */
    ...
    /**
     * OpenCV opencv3 initialization has failed.
     */
    static final int INIT_FAILED = 0xff;

    /**
     * Callback method, called after OpenCV opencv3 initialization.
