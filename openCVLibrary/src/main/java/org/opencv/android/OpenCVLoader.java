...
/**
 * Helper class provides common initialization methods for OpenCV opencv3.
 */
public class OpenCVLoader
{
    ...
    /**
     * Loads and initializes OpenCV opencv3 from current application package. Roughly, it's an analog of system.loadLibrary("opencv_java").
    ...
    /**
     * Loads and initializes OpenCV opencv3 using OpenCV Engine service.
     * @param Version OpenCV opencv3 version.
