...
class AsyncServiceHelper
{
    ...
    protected static void InstallService(final Context AppContext, final LoaderCallbackInterface Callback)
    {
        if (!mServiceInstallationProgress)
        {
                ...
                public void cancel()
                {
                    Log.d(TAG, "OpenCV opencv3 installation was canceled");
        ...
        public void onServiceConnected(ComponentName className, IBinder service)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Log.d(TAG, "Trying to get opencv3 path");
                    ...
                    {
                        Log.d(TAG, "Trying to get opencv3 list");
                        mLibraryInstallationProgress = false;
    ...
    private boolean loadLibrary(String AbsPath)
    {
        ...
        Log.d(TAG, "Trying to load opencv3 " + AbsPath);
        try
        {
            System.load(AbsPath);
        ...
        {
            Log.d(TAG, "Cannot load opencv3 \"" + AbsPath + "\"");
            e.printStackTrace();
            result &= false;
        }
